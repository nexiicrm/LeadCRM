...
public class Login extends Helper{
		...
		public void Login_CRM() throws Exception{
		   ...
		   */
		   ...
		   //Getting Log in credentials for all modules from database and trying to log in 
			...
			ArrayList<String> sr3= new ArrayList<String>();
	    	  try {  
	              ...
	              while (resultSet.next()) {
	                  ...
	                  if(!(role.equals("Architect") || role.equals("VPSales") ||role.equals("Manager"))){
	                  sr1.add(role);      
	                  sr2.add(email);
	                  sr3.add(pass);
	                  			}
	    	  ...
	    	  //Loop executes for all different modules 
