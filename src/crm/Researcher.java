...
public class Researcher extends Helper{
   ...
   @Test
   public void b_LC_TS18_TC001_Uploadinvaliddata() throws Exception {
   ...
   @Test
   public void c_LC_TS18_TC002_Leadsuploadvaliddata() throws Exception {
		...
		HashMap<String,String> lead= new HashMap<String,String>();
		   ...
		   try {
			     ...
			     resultSet = statement.executeQuery("select  a.role_name, b.email_id, b.password "
	                 ...
	                 + "a.role_id = b.role_id AND b.delete_status='no' AND role_name='BDM' Limit 2;");
 ...
 @Test
  public void d_LC_TS19_TC001_Searchleads() throws Exception {
 ...
 @Test
  public void e_LC_TS19_TC002_Searchleadpagenavigation() throws Exception {
  ...
  @Test
  public void f_LC_TS_22_Changepassword() throws Exception {
